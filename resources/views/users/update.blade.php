        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    {!! Form::model($user,['method' =>'PUT', 'url' => ["users",$user->id],'class'=>'form-horizontal', 'role' => 'form', 'enctype' => "multipart/form-data"]) !!}
                        ...
                        @foreach($permissions as $key => $permission)
                            <div class="col-md-6 col-md-offset-4">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" value="{{ $permission->id }}" for="exampleCheck{{ $permission->id }}">{{ $permission->name }}</label>
                                </div>
                            </div>
                        @endforeach
